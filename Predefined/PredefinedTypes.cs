...
public class PredefinedTypes
{
    ...
    public static readonly DataType[] NumericStd = {
        DataType.StdLogic, DataType.StdLogicVector, DataType.Integer, DataType.Signed, DataType.Natural, DataType.Unsigned, DataType.Positive, DataType.Boolean, DataType.Time, DataType.String, DataType.Bit, DataType.BitVector
    };
