...
public static class PredefinedFunctions
{
    ...
    private static readonly CustomDefinedFunction CeilFromStdLogicVector = new("ceil", "returns smallest integer value (as real) not less than X")
    {
        ReturnType = DataType.Real,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction CeilFromReal = new("ceil", "returns smallest integer value (as real) not less than X")
    {
        ReturnType = DataType.Real,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction ToIntegerFromUnsigned = new("to_integer", "Converts Unsigned to Integer")
    {
        ReturnType = DataType.Integer,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction StdLogicVectorFromSigned = new("std_logic_vector", "Converts Signed to STD_LOGIC_VECTOR")
    {
    ...
    private static readonly CustomDefinedFunction StdLogicVectorFromUnsigned = new("std_logic_vector", "Converts Unsigned to STD_LOGIC_VECTOR")
    {
        ReturnType = DataType.StdLogicVector,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction RisingEdge = new("rising_edge", "Detects the rising edge of a std_logic signal")
    {
    ...
    private static readonly CustomDefinedFunction FallingEdge = new("falling_edge", "Detects the falling edge of a std_logic signal")
    {
        ReturnType = DataType.Boolean,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction ShiftRight = new("shift_right", "Performs a shift-right on an UNSIGNED vector COUNT times")
    {
        ReturnType = DataType.Unsigned,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction ShiftLeft = new("shift_left", "Performs a shift-left on an UNSIGNED vector COUNT times")
    {
        ReturnType = DataType.Unsigned,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction ConvInteger = new("conv_integer", "Converts STD_LOGIC_VECTOR to integer")
    {
        ReturnType = DataType.Integer,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction ConvStdLogicVectorFromInteger = new("conv_std_logic_vector", "Converts Integer to STD_LOGIC_VECTOR")
    {
        ReturnType = DataType.StdLogicVector,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction ConvStdLogicVectorFromUnsigned = new("conv_std_logic_vector", "Converts Unsigned to STD_LOGIC_VECTOR")
    {
        ReturnType = DataType.StdLogicVector,
        Parameters =
        {
    ...
    private static readonly CustomDefinedFunction ConvStdLogicVectorFromSigned = new("conv_std_logic_vector", "Converts Signed to STD_LOGIC_VECTOR")
    {
        ReturnType = DataType.StdLogicVector,
        Parameters =
        {
    ...
    public static readonly Dictionary<string, IEnumerable<CustomDefinedFunction>> NumericStd = new()
    {
        ...
        {"conv_std_logic_vector", new []{ConvStdLogicVectorFromInteger, ConvStdLogicVectorFromSigned, ConvStdLogicVectorFromUnsigned}},
        {"to_bit", new []{ToBit}},
